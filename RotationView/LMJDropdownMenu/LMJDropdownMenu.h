...
- (void)setMenuTitles:(NSArray *)titlesArr rowHeight:(CGFloat)rowHeight ButtonTitle:(NSString *)title; // 设置下拉菜单控件样式

- (void)setMenuTitles:(NSArray *)titlesArr rowHeight:(CGFloat)rowHeight OnlyImage:(UIImage*)image;//图片居中，不带动画

//- (void)setCanlendarMenuWithButtonTitle:(NSString *)title;
